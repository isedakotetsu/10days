...
void block::Move(const Vector3& playerPosition) {
	...
	// ========================================
	if (playerPosition.x >= worldTransform_.translation_.x - blockkWidth_ / 2.0f && playerPosition.x <= worldTransform_.translation_.x + blockkWidth_ / 2.0f &&
...
void block::Update(const Vector3& playerPosition) { Move(playerPosition); }
